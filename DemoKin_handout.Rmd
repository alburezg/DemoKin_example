...
An member of the population aged 15, 50, and 65yo will have experienced, on average, the death of `r loss2 %>% filter(age_ego %in% c(15, 50, 65)) %>% pull(total) %>% round(1) %>% paste(., collapse = ", ")` relatives, respectively. 
We can decompose this by relative type:
