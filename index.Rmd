...
An member of the population aged 15, 50, and 65yo will have experienced, on average, the death of `r loss2 %>% filter(age_focal %in% c(15, 50, 65)) %>% pull(count) %>% round(1) %>% paste(., collapse = ", ")` relatives, respectively. 
We can decompose this by relative type:
...
We can say that the mothers of Focal would be, on average, `r ma` years old, with a standard deviation of `r sda` years. 
